-- Owner-only role and achievement grants. This runs after the owner enum migration.
...
AS $$
BEGIN
  IF NOT public.has_role(_actor, 'owner'::public.app_role) THEN RAISE EXCEPTION 'Owner role required'; END IF;
